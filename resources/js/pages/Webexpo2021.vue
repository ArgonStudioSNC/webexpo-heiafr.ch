    ...
    <div id="webexpo" class="webexpo">
        ...
        <div class="webexpo-title grid-y align-center text-right">
            ...
            <h1 class="cell bg-color">
                <div class="grid-container blend"><a href="#gallery" v-foundation data-smooth-scroll data-animation-duration='300' data-animation-easing='swing' data-offset="-25.6">Travaux<br>Bachelor&nbsp;&amp;<br>Master 20I21</a></div>
            </h1>
...
export default {
    ...
    setup () {
        ...
        store.dispatch( 'loadProjects', 2021);
    },

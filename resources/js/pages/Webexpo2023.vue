    ...
    <div id="webexpo" class="webexpo">
        ...
        <div class="webexpo-title grid-y align-center text-right">
            ...
            <h1 class="cell bg-color">
                <div class="grid-container blend"><a href="#gallery" data-smooth-scroll data-animation-duration='300' data-animation-easing='swing' data-offset="-25.6">Travaux<br>Bachelor&nbsp;&amp;<br>Master 22I23</a></div>
            </h1>
            <h1 class="cell grid-container blend">Exposition<br>en ligne</h1>
        </div>
        <div id="gallery" class="disabled">
...
export default {
    ...
    created() {
        this.$store.dispatch( 'loadProjects', 2023);
        $('body').addClass('theme-2023');
    },

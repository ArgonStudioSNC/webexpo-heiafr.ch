    ...
    <div id="webexpo" class="webexpo">
        ...
        <div class="webexpo-title grid-y align-center text-right">
            ...
            <h1 class="cell bg-color">
                <div class="grid-container blend"><a href="#gallery" data-smooth-scroll data-animation-duration='300' data-animation-easing='swing' data-offset="-25.6">Travaux<br>Bachelor&nbsp;&amp;<br>Master 24I25</a></div>
            </h1>
...
export default {
    ...
    created() {
        this.$store.dispatch( 'loadProjects', 2025);
        $('body').addClass('theme-2025');
    },
    ...
    methods: {
        ...
        isOnline() {
            const onlineDate = new Date('2025-09-08T06:00:00');
